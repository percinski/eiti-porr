 ...
 *
 * VERSION TO RUN IN DISTRIBUTED MANNER
 *
 * author: perciax
 * created: 2017-01-15
 *
...
use CyclicDist; // use Cyclic distribution module
use Time;
...
while(e>stop){
    ...
    const localTasks = {1..p} dmapped Cyclic(startIdx=1);
	forall i in localTasks do solvelocal(i);
